...
class ScreenSelection extends Screen{
  constructor(elemId) {
    ...
    this.canvasElem.addEventListener('mousemove', (e) => {this._OnMouseMove(e);}, false);
    this.canvasElem.addEventListener('mousedown', (e) => {this._OnMouseDown(e);}, false);
    this.canvasElem.addEventListener('mouseup', (e) => {this._OnMouseUp(e);}, false);
    document.body.addEventListener('mousemove', (e) => {this.updateCanvas();}, false);
